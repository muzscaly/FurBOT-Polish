...
def afk(bot: Bot, update: Update):
    ...
    update.effective_message.reply_text("{} jest AFK! ".format(update.effective_user.first_name))
...
def no_longer_afk(bot: Bot, update: Update):
    ...
    if res:
        update.effective_message.reply_text("{} nie jest już AFK!".format(update.effective_user.first_name))
